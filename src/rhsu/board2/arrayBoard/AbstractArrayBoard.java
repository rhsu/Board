	...
	BoardInitializable<T>
{
	...
	@Override
	public MobilityBoard<T> getMobilityBoard() { return (MobilityBoard<T>) boardModules.get(AbstractArrayBoard.MATRIX);}

	@Override
	public RandomGenerator<T> getRandomGenerator() { return (RandomGenerator<T>) boardModules.get(AbstractArrayBoard.MATRIX);}
	...
	@Override
 	public boolean equals(Object aInstance)
 	{
 		...
 		if ( !(aInstance instanceof Board2 ) ) return false; 
 		
 		Board2 instance = (Board2) aInstance;
 		
 		return
 			instance.getHorizontalSize() == this.getHorizontalSize() &&
 			instance.getVerticalSize() == this.getVerticalSize() &&
 			Arrays.deepEquals((Object[]) instance.getInnerBoardRepresentation(), this.getInnerBoardRepresentation());
 	}
		...
		BoardInitializable<T> boardInitializer)
	{
		...
		this.boardModules.put(AbstractArrayBoard.MOBILITY_BOARD, mobilityBoard);
		this.boardModules.put(AbstractArrayBoard .RANDOM_GENERATOR, randomGenerator);
